...
//            _app.Entity("light.kitchen").TurnOn(attributes: "brightness = 100");
//            _app.Entity("light.kitchen").TurnOff(attributes: "brightness = 100");
//            _app.Entity("light.kitchen").Toggle(attributes: "brightness = 100");
//        }
//        );
...
//        .StateChanges
//        .Where(e => e.New?.State == "on" && e.Old?.State == "off")
//        .Subscribe(_ => _app.Entity("sensor.mysensor").SetState(20, attributes: "battery_level = 90"));
...
//        _app.SetState("sensor.any_sensor", 20, attributes: "battery_level = 70");
//        _app.SetState("sensor.any_sensor2", 20, attributes: "battery_level = 70");
